...
with models.DAG(
    ...
    run_scarface_fraud_deleted = SSHOperator(
        ...
        ssh_hook=sshHook,
        command="sh /opt/dw_schibsted/yapo_bi/dw_blocketdb/Blocket/run_scarface_fraud_deleted.sh ",  # You need add a space at the end of the command, to avoid error: Jinja template not found
    )

    run_scarface_fraud_deleted
