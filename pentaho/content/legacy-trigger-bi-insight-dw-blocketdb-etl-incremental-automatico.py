...
with models.DAG(
    ...
    run_etl_incremental_automatico = SSHOperator(
        ...
        ssh_hook=sshHook,
        command="sh /opt/dw_schibsted/yapo_bi/dw_blocketdb/run_etl_incremental_automatico.sh ",  # You need add a space at the end of the command, to avoid error: Jinja template not found
    )

    run_etl_incremental_automatico
