...
# DEFINE INIT PARAMS
# Dag
dag_name = "legacy_scrapping-cha_scrapping_chileautos_dealers"
dag_tags = [
    "production",
    "ETL",
    "schedule",
    "dockerhost",
    "legacy",
    "git: legacy/scrapping-cha",
    "input: pending",
    "output: pending",
]
# Docker image
docker_image = "gcr.io/data-poc-323413/legacy/data-user-behavior-scrapper-cha:latest"
# Schedule interal
schedule_interval = "0 12 * * 5"
# Slack msg
riskiness = "High"
utility = "This ETL is related to scrapping chileautos dealers"
...
with models.DAG(
    ...
    def call_ssh(**kwargs):
        ...
        call = ssh_operator.SSHOperator(
            task_id="task_scrapping_chileautos_dealers",
            ssh_hook=sshHook,
    ...
    scrapping_chileautos_dealers = python_operator.PythonOperator(
        task_id="task_scrapping_chileautos_dealers",
        provide_context=True,
        python_callable=call_ssh,
    )

    scrapping_chileautos_dealers
