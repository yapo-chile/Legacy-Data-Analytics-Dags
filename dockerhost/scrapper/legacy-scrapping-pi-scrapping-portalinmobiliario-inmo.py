...
# DEFINE INIT PARAMS
# Dag
dag_name = "legacy_scrapping-pi_scrapping_portalinmobiliario_inmo"
dag_tags = [
    "production",
    "ETL",
    "schedule",
...
with models.DAG(
    ...
    def call_ssh(**kwargs):
        ...
        call = ssh_operator.SSHOperator(
            task_id="task_scrapping_portalinmobiliario_inmo",
            ssh_hook=sshHook,
    ...
    scrapping_portalinmobiliario_inmo = python_operator.PythonOperator(
        task_id="task_scrapping_portalinmobiliario_inmo",
        provide_context=True,
        python_callable=call_ssh,
    )

    scrapping_portalinmobiliario_inmo
