...
# DEFINE INIT PARAMS
# Dag
dag_name = "legacy_data-content_peak-revenues"
dag_tags = [
    "production",
    "ETL",
    "schedule",
...
with models.DAG(
    ...
    def call_ssh(**kwargs):
        ...
        call = ssh_operator.SSHOperator(
            task_id="task_run_peak_revenues",
            ssh_hook=sshHook,
    ...
    run_peak_revenues = python_operator.PythonOperator(
        task_id="task_run_peak_revenues", provide_context=True, python_callable=call_ssh
    )
