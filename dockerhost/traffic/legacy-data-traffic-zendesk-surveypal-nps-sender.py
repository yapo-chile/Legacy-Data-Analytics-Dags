...
# DEFINE INIT PARAMS
# Dag
dag_name = "legacy_data-traffic_zendesk_surveypal_nps_sender"
dag_tags = [
    "production",
    "ETL",
    "schedule",
    "dockerhost",
    "legacy",
    "git: legacy/data-traffic",
    "input: pending",
    "output: pending",
]
# Docker image
docker_image = "gcr.io/data-poc-323413/legacy/nps-sender:latest"
# Schedule interal
schedule_interval = "0 7 * * *"
# Slack msg
riskiness = "Medium"
utility = "ETL related to zendesk surveypal nps sender"
...
with models.DAG(
    ...
    def call_ssh(**kwargs):
        ...
        call = ssh_operator.SSHOperator(
            task_id="task_zendesk_surveypal_nps_sender",
            ssh_hook=sshHook,
    ...
    zendesk_surveypal_nps_sender = python_operator.PythonOperator(
        task_id="task_zendesk_surveypal_nps_sender",
        provide_context=True,
        python_callable=call_ssh,
    )

    zendesk_surveypal_nps_sender
