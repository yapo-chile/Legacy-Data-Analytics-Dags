...
# DEFINE INIT PARAMS
# Dag
dag_name = "legacy_data-content_new_approved_ads"
dag_tags = [
    "production",
    "ETL",
    "schedule",
...
# Docker image
docker_image = (
    "containers.mpi-internal.com/yapo/data-content-peak-new-approved-ads:latest"
)
# Schedule interal
schedule_interval = "0 11 * * *"
# Slack msg
riskiness = "Medium"
utility = "Legacy etl related to peak new approved ads"
...
with models.DAG(
    ...
    new_approved_ads = python_operator.PythonOperator(
        task_id="task_new_approved_ads",
