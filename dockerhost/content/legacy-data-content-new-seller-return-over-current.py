...
# DEFINE INIT PARAMS
# Dag
dag_name = "legacy_data-content_seller_return_over_current"
dag_tags = [
    "production",
    "ETL",
    "schedule",
...
# Docker image
docker_image = "containers.mpi-internal.com/yapo/data-content-seller-return-over-current-past:latest"
# Schedule interal
schedule_interval = "0 11 * * *"
# Slack msg
riskiness = "Medium"
utility = "Legacy etl related to Sellers return over current past"
...
with models.DAG(
    ...
    def call_ssh(**kwargs):
        ...
        call = ssh_operator.SSHOperator(
            task_id="task_seller_return_over_current",
            ssh_hook=sshHook,
    ...
    seller_return_over_current = python_operator.PythonOperator(
        task_id="task_seller_return_over_current",
        provide_context=True,
        python_callable=call_ssh,
    )

    seller_return_over_current
